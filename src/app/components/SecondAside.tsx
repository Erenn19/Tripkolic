...
export const SecondAside: React.FC<PropsAside> = ({
    initialName,
    initialSurname,
    initialCountry,
    initialBirthday,
    ...
    return (
        <div>
            <div className='text-black bg-white flex flex-col w-96 gap-4 ml-16 mt-6'>
...
// export const SecondAside:React.FC<PropsSecondAside>=({name,surname,country,birthday,Passport_number,Phone_number}) =>{
//   return (
//     <div>
//       <div className='text-black bg-white flex flex-col w-96 gap-4 pt-12  ml-16'>
...
//         </div>
//         <div>
//           <span className='font-bold'>Passport number: </span> {Passport_number}
//         </div>
//         <div>
//           <span className='font-bold'>Phone number: </span>{Phone_number}
//         </div>
//       </div>
//     </div>
//   )
